...
<?php include("./header.php"); ?>
  <section id="container">
    ...
    <div class="head">
      <h1 style="background-color: #000;">TRANSPORT</h1>
    </div>
    <?php
    $sql="SELECT * FROM master_list WHERE item_category='transport' and status='active'";
      ...
      <div class="card-flip">
        ...
        <div class="card front">
          <div id=<?php echo $data_bs_id;?> class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <?php echo '<img src="./transport/'.$row["item_name"].'/'.$image[0].'" class="d-block w-100" alt="..." height="564" width="846">';?>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <form action="transportback.php" method="post">
